...
def get_filters():
    ...
    while city_name.lower() not in CITY_DATA:
        city_name = input("\ncan you please select one of the cities you want to get the data? the input should be either chicago, new york , washington\n")
        if city_name.lower() in CITY_DATA:

            city = CITY_DATA[city_name.lower()]
        else:

            print("Sorry maybe you entre a false city , can you please input either chicago, new york  or washington.\n")

    # TO DO: get user input for month (all, january, february, ... , june)
    month_name = ''
    while month_name.lower() not in MONTH_DATA:
        month_name = input("\ncan you please select a month you want to get the data? the input should ne either 'all' to be no month filter or january, february, ... , june\n")
        if month_name.lower() in MONTH_DATA:

            month = month_name.lower()
        else:

            print("Sorry maybe you entre a false month , Please input either 'all' to apply no month filter or january, february, ... , june.\n")

    # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    day_name = ''
    while day_name.lower() not in DAY_DATA:
        day_name = input("\nWhat is the name of the day you want to get the data? the input should be either 'all' to apply no day filter or monday, tuesday, ... sunday\n")
        if day_name.lower() in DAY_DATA:

            day = day_name.lower()
        else:
            #We were not able to get the name of the month to analyze data so we continue the loop.
            print("Sorry maybe you entre a false day , Please input either 'all' to apply no day filter or monday, tuesday, ... sunday.\n")
...
def user_stats(df, city):
    ...
    if city == 'chicago.csv' or city == 'new_york_city.csv':
        ...
        print("The count of user gender from the given data is: \n" + str(gender))
